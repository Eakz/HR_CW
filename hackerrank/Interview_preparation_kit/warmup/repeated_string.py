...
# and , the substring we consider is , the first characters of her
#  infinite string. There are
...
# Explanation 0
# The first
# letters of the infinite string are abaabaabaa. Because there are a's,
#  we print
...
print(repeatedString('a',1000000)) # 1000000