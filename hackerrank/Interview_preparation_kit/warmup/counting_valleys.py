...
#   hike he took exactly steps. For every step he took, he noted if
#    it was an uphill, , or a downhill, step. Gary's hikes start and
#     end at sea level and each step up or down represents a
...
# , he first enters a valley units deep. Then he climbs out an up
#  onto a mountain
...
# If we represent _ as sea level, a step up as /, and a step down
#  as \, Gary's hike can be drawn as:
